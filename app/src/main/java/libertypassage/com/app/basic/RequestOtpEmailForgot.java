...
public class RequestOtpEmailForgot extends AppCompatActivity implements View.OnClickListener{
    private Context context;
    private String TAG = RequestOtpEmailForgot.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RequestOtpEmailForgot.this;
        findID();
    }
