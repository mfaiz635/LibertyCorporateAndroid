...
public class RedLocationAlert extends AppCompatActivity implements View.OnClickListener {

    private final String TAG = RedLocationAlert.class.getSimpleName();
    private CenturyGothicTextview tv_lastStatusChange, tv_submit;
    ...
    private String token, confirm="0", address, dateChangeStatus="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.red_location_alert);

        context = RedLocationAlert.this;
        findID();
    }
    ...
    private void findID() {
        ...
        if(!dateChangeStatus.isEmpty()) {
            ...
            tv_lastStatusChange.setText("Confirmed Infected on " + dateChangeStatus);
        }else {
    ...
    private void falseLocationAlert() {
        Utility.showProgressDialog(context);
        ApiInterface apiInterface = ClientInstance.getRetrofitInstance().create(ApiInterface.class);
        Call<ModelResponse> call = apiInterface.falseLocationAlert(Constants.KEY_HEADER+token, Constants.KEY_BOT, confirm, address);
        ...
        call.enqueue(new Callback<ModelResponse>() {
            ...
            public void onResponse(Call<ModelResponse> call, Response<ModelResponse> response) {
                ...
                Log.e("RedAlert", new Gson().toJson(model));
