...
public class QRCodeScanerActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(QRCodeScanerActivity.this, new
...
//        startActivity(intent);
        ...
        finish();
        Toast.makeText(QRCodeScanerActivity.this, "QR code scanned succefully", Toast.LENGTH_SHORT).show();
