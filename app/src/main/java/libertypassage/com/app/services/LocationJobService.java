...
public class LocationJobService extends android.app.job.JobService {
    private static String TAG= LocationJobService.class.getSimpleName();
    private static RestartServiceBroadcastReceiver restartSensorServiceReceiver;
    private static LocationJobService instance;
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        ...
        instance= this;
        LocationJobService.jobParameters= jobParameters;
