...
public class CountryCodeSpinnerAdapter extends ArrayAdapter<String> {
    ...
    public CountryCodeSpinnerAdapter(Context context, int resource, ArrayList<String> items) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            view.setTextColor(getContext().getResources().getColor(R.color.suggestion_color));
        } else {
