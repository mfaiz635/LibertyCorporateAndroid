...
public class CircleSeekBar extends View {
    ...
    private double mMaxProcess;
    private double mMinProcess;
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        ...
        mMaxProcess = a.getInt(R.styleable.CircleSeekBar_wheel_max_process, 20);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            mMinProcess = bundle.getInt(INSTANCE_MIN_PROCESS);
    ...
    public void setCurProcess(double curProcess) {
    ...
    public double getMinProcess() {
        return mMinProcess;
    }

    public void setMinProcess(double minProcess) {
