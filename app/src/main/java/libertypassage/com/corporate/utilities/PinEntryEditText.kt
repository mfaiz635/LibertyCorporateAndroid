...
class PinEntryEditText : AppCompatEditText {
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        val colorFocused =
            if (isInEditMode) Color.GRAY else ContextCompat.getColor(context, R.color.white)
    ...
    fun setOnPinEnteredListener(pinEnteredListener: OnPinEnteredListener) {
        mOnPinEnteredListener = pinEnteredListener
    }
