...
class IndustryAdapter(val context: Context, var dataSource: ArrayList<DetailIndustry>) : BaseAdapter() {
    ...
    private class ItemHolder(row: View?) {
        val label: TextView = row?.findViewById(R.id.lbl_name) as TextView
    }
}